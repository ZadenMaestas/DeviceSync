...
<div class="container">
    ...
    <div class="row">
        <div class="text-center col">
            ...
            <h4>DeviceSync is an open source cross-platform note-taking application, it is licensed under the MIT
                License and the source code is available here: <a href="http://github.com/ZadenMaestas/DeviceSync"
    ...
    <div class="row">
        ...
        <div class="text-center col">
            ...
            <a href="myAccount.php?mode=signup" class="button outline primary">Sign Up</a>
            <br>
            <br>
            <p>Or</p>
            <a href="myAccount.php?mode=signin" class="button outline primary">Sign In</a>
        </div>
    </div>
    <?php
